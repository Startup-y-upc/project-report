...
<p align="center"><strong>Profesor:</strong> Quevedo Velasco, David Gerardo</p><br>
...
<p align="center"><strong>Producto:</strong> Rent2Go</p><br>
...
**Resumen de actividad:** Durante TB2 el equipo cerró el Sprint 3 como una continuidad del Sprint 2, enfocándose en completar las historias de usuario pendientes en las aplicaciones móviles, ajustar el Landing Page para alinearlo con la propuesta real de Rent2Go y consolidar la evidencia documental de la entrega final. El esfuerzo se concentró en Kotlin y Flutter, mientras que el backend se mantuvo como base estable ya completada en entregas previas.
...
| Repositorio | Insight clave de TB2 |
| ----------- | --------------------- |
| project-report | Consolidación del reporte final, registro de versiones, Student Outcome y conclusiones de cierre para TB2. |
| rent2go-kotlin | Se completaron los flujos restantes en Android/Kotlin, alcanzando una implementación final estable y alineada con la propuesta del producto. |
| rent2go-flutter | Se cerraron las funcionalidades pendientes en Flutter, reforzando la consistencia de experiencia y la integración con el flujo de negocio. |
| rent2go-backend | No se incorporaron nuevas funcionalidades de backend en este sprint; se mantuvo la base ya completada y validada en entregas previas. |
| landing-page | Se ajustó la narrativa y el contenido del Landing Page para reflejar mejor la propuesta de valor de Rent2Go según las entrevistas de validación. |

**Evidencia:**

<div align="center">
  <img src="Resources/collaboration/tb2-contributors-1.png" style="margin: 10px 0;" width="85%"/>
</div>

<div align="center">
  <img src="Resources/collaboration/tb2-overview-1.png" style="margin: 10px 0;" width="85%"/>
</div>

<div align="center">
  <img src="Resources/collaboration/tb2-contributors-2.png" style="margin: 10px 0;" width="85%"/>
</div>

<div align="center">
  <img src="Resources/collaboration/tb2-overview-2.png" style="margin: 10px 0;" width="85%"/>
</div>

<div align="center">
  <img src="Resources/collaboration/tb2-contributors-3.png" style="margin: 10px 0;" width="85%"/>
</div>

<div align="center">
  <img src="Resources/collaboration/tb2-overview-3.png" style="margin: 10px 0;" width="85%"/>
</div>
...
- [4.2. Landing Page & Mobile Application Implementation](Capitulo_4.md#42-landing-page--mobile-application-implementation)
  ...
  - [4.2.2. Sprint 2](Capitulo_4.md#422-sprint-2)
    ...
    - [4.2.2.8. Team Collaboration Insights during Sprint 2](Capitulo_4.md#4218-team-collaboration-insights-during-sprint-2)
  - [4.2.3. Sprint 3](Capitulo_4.md#423-sprint-3)
    - [4.2.3.1. Sprint Planning 3](Capitulo_4.md#4231-sprint-planning-3)
    - [4.2.3.2. Sprint Backlog 3](Capitulo_4.md#4232-sprint-backlog-3)
    - [4.2.3.3. Development Evidence for Sprint Review](Capitulo_4.md#4233-development-evidence-for-sprint-review)
    - [4.2.3.4. Testing Suite Evidence for Sprint Review](Capitulo_4.md#4234-testing-suite-evidence-for-sprint-review)
    - [4.2.3.5. Execution Evidence for Sprint Review](Capitulo_4.md#4235-execution-evidence-for-sprint-review)
    - [4.2.3.6. Services Documentation Evidence for Sprint Review](Capitulo_4.md#4216-services-documentation-evidence-for-sprint-review)
    - [4.2.3.7. Software Deployment Evidence for Sprint Review](Capitulo_4.md#4217-software-deployment-evidence-for-sprint-review)
    - [4.2.3.8. Team Collaboration Insights during Sprint 3](Capitulo_4.md#4218-team-collaboration-insights-during-sprint-3)
...
| --------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Actualiza conceptos y conocimientos necesarios para su desarrollo profesional y en especial para su proyecto en soluciones de software. | - **Castillo Vidal, Jesus Ivan**<br>&nbsp;&nbsp;- **AV1:** Cumplió el criterio al aplicar conceptos de análisis del contexto, competencia y validación inicial en la descripción de la startup y el diseño de entrevistas con enfoque mobile-first.<br>&nbsp;&nbsp;- **TB1:** Cumplió el criterio al desarrollar las pantallas core de la aplicación móvil en Kotlin, implementando navegación funcional y consumo de servicios del backend desplegado.<br>&nbsp;&nbsp;- **AV2:** Cumplió el criterio al completar la integración con el backend, alcanzando el 70% de funcionalidad implementada, validando consumo de servicios y persistencia de datos para la demostración del Sprint 2.<br>&nbsp;&nbsp;- **TB2:** Cumplió el criterio al consolidar la validación final del producto, documentar la evaluación heurística con el formato indicado y preparar la demostración de Kotlin con evidencia de Sprint 3.<br><br>- **Chavez Uribe, Ario Joel**<br>&nbsp;&nbsp;- **AV1:** Cumplió el criterio al incorporar enfoques de Lean UX y traducirlos en artefactos de requisitos (historias, impacto y backlog) según la guía.<br>&nbsp;&nbsp;- **TB1:** Cumplió el criterio al desarrollar funcionalidades móviles en Kotlin, implementando pruebas técnicas y documentación de servicios consumidos.<br>&nbsp;&nbsp;- **AV2:** Cumplió el criterio al completar la integración con el backend, garantizando estabilidad de funcionalidades desarrolladas y documentando pruebas realizadas con evidencias gráficas.<br>&nbsp;&nbsp;- **TB2:** Cumplió el criterio al reforzar la validación de entrevistas, documentar la evaluación de usabilidad y preparar el video demo de Flutter y el video about the product para la entrega final.<br><br>- **Carhuancote Dominguez, Gonzalo Alonso**<br>&nbsp;&nbsp;- **AV1:** Cumplió el criterio al articular segmentos objetivo y al aplicar principios de DDD estratégico y táctico para la solución móvil.<br>&nbsp;&nbsp;- **TB1:** Cumplió el criterio al desarrollar el Capítulo III (Solution UI/UX Design), elaborando wireframes, mockups y flujos de navegación móvil.<br>&nbsp;&nbsp;- **AV2:** Cumplió el criterio al desarrollar las principales pantallas y funcionalidades móviles en Kotlin, implementando navegación funcional e integración con el backend desplegado, garantizando que las funcionalidades desarrolladas puedan ser utilizadas durante la demostración del Sprint 2. Adicionalmente, consolidó el Capítulo III con Wireflow Diagrams, User Flow Diagrams y prototipos interactivos en Figma, manteniendo consistencia entre diseño e implementación.<br>&nbsp;&nbsp;- **TB2:** Cumplió el criterio al apoyar la consolidación del reporte Sprint 3 con imágenes, completar el avance de Kotlin y Flutter y preparar material visual de exposición para la demo final.<br><br>- **Diestra Zambrano, Adriana Maria**<br>&nbsp;&nbsp;- **AV1:** Cumplió el criterio al estructurar la problemática y aplicar técnicas de needfinding y user stories para sustentar necesidades de usuarios.<br>&nbsp;&nbsp;- **TB1:** Cumplió el criterio al desarrollar la aplicación móvil en Flutter, implementando funcionalidades core y recopilando evidencias visuales para Sprint Review.<br>&nbsp;&nbsp;- **AV2:** Cumplió el criterio al completar la integración con el backend en Flutter, verificando navegación, consumo de servicios y experiencia de usuario, además de elaborar material audiovisual de validación.<br>&nbsp;&nbsp;- **TB2:** Cumplió el criterio al reforzar la experiencia en Flutter, preparar evidencias de validación y apoyar la demostración final del producto con una solución más consistente.<br><br>- **Huarcaya Matias, Gilbert Alonso**<br>&nbsp;&nbsp;- **AV1:** Cumplió el criterio al consolidar el Lean UX Canvas y organizar evidencias de entrevistas e impacto para asegurar trazabilidad.<br>&nbsp;&nbsp;- **TB1:** Cumplió el criterio al desarrollar la arquitectura backend, endpoints REST y lógica de negocio inicial, documentando despliegue y evidencias de integración.<br>&nbsp;&nbsp;- **AV2:** Cumplió el criterio al completar el 100% de implementación del backend en entorno público, documentar despliegue completo, incorporar evidencias de APIs implementadas y ayudar en integración con aplicaciones móviles.<br>&nbsp;&nbsp;- **TB2:** Cumplió el criterio al completar Kotlin, Flutter y el avance del reporte Sprint 3 con imágenes, además de apoyar la demo backend y la consolidación final del proyecto. | En AV1, el equipo actualizó y aplicó conceptos del guideline y de Lean UX para alinear el reporte y el enfoque mobile-first con los criterios del curso.<br><br>En TB1, el equipo consolidó el aprendizaje al desarrollar las pantallas core de la aplicación móvil, desplegar el Landing Page y alcanzar el 70% del backend, aplicando conceptos de UI/UX, desarrollo móvil y arquitectura backend.<br><br>En AV2, el equipo demostró actualización continua al completar el 100% del backend, implementar funcionalidades core en Kotlin y Flutter, y elaborar videos de validación, consolidando conocimientos de integración, despliegue y validación.<br><br>En TB2, el equipo cerró la entrega final reforzando la validación del producto, la documentación de evidencia y la preparación de demos de Kotlin, Flutter y el video about the product. |
| Reconoce la necesidad del aprendizaje permanente para el desempeño profesional y el desarrollo de proyectos en soluciones de software.  | - **Castillo Vidal, Jesus Ivan**<br>&nbsp;&nbsp;- **AV1:** Evidenció aprendizaje continuo al detectar vacíos en entrevistas y competencia y dejar acciones de mejora para la siguiente entrega.<br>&nbsp;&nbsp;- **TB1:** Evidenció aprendizaje continuo al aprender desarrollo móvil en Kotlin, implementando navegación funcional y consumo de servicios del backend.<br>&nbsp;&nbsp;- **AV2:** Evidenció aprendizaje continuo al profundizar en integración con backend, alcanzando el 70% de funcionalidad y validando persistencia de datos para demostración.<br>&nbsp;&nbsp;- **TB2:** Evidenció aprendizaje continuo al consolidar la validación heurística, preparar el video demo de Kotlin y ajustar las evidencias finales para la entrega TB2.<br><br>- **Chavez Uribe, Ario Joel**<br>&nbsp;&nbsp;- **AV1:** Evidenció aprendizaje continuo al identificar que las hipótesis y la validación de impacto requieren mayor profundidad y planificar su refuerzo.<br>&nbsp;&nbsp;- **TB1:** Evidenció aprendizaje continuo al aprender desarrollo móvil en Kotlin, documentando pruebas técnicas y servicios consumidos.<br>&nbsp;&nbsp;- **AV2:** Evidenció aprendizaje continuo al profundizar en pruebas y documentación técnica, garantizando estabilidad y preparando funcionalidades para demostración del Sprint.<br>&nbsp;&nbsp;- **TB2:** Evidenció aprendizaje continuo al fortalecer la validación de entrevistas, preparar el video demo de Flutter y consolidar las evidencias de producto para TB2.<br><br>- **Carhuancote Dominguez, Gonzalo Alonso**<br>&nbsp;&nbsp;- **AV1:** Evidenció aprendizaje continuo al planificar la ampliación de arquitectura y diagramas para mejorar la claridad del sistema en el siguiente avance.<br>&nbsp;&nbsp;- **TB1:** Evidenció aprendizaje continuo al aprender técnicas de diseño UI/UX móvil, elaborando wireframes, mockups y flujos de navegación.<br>&nbsp;&nbsp;- **AV2:** Evidenció aprendizaje continuo al desarrollar las principales pantallas y funcionalidades móviles en Kotlin, implementando navegación funcional e integración con el backend desplegado. Adicionalmente, consolidó el Capítulo III con Wireflow Diagrams, User Flow Diagrams y prototipado interactivo en Figma, manteniendo consistencia entre diseño e implementación.<br>&nbsp;&nbsp;- **TB2:** Evidenció aprendizaje continuo al preparar material visual para la exposición, reforzar el reporte Sprint 3 y apoyar la finalización de Kotlin y Flutter para la entrega final.<br><br>- **Diestra Zambrano, Adriana Maria**<br>&nbsp;&nbsp;- **AV1:** Evidenció aprendizaje continuo al dejar mejoras pendientes en eventstorming y lenguaje ubicuo con un plan de cierre para AV2/TB1.<br>&nbsp;&nbsp;- **TB1:** Evidenció aprendizaje continuo al aprender desarrollo móvil en Flutter, implementando funcionalidades core y recopilando evidencias visuales.<br>&nbsp;&nbsp;- **AV2:** Evidenció aprendizaje continuo al profundizar en integración con backend en Flutter, verificando experiencia de usuario y elaborando material audiovisual de validación.<br>&nbsp;&nbsp;- **TB2:** Evidenció aprendizaje continuo al reforzar la experiencia en Flutter, consolidar la validación de la interfaz y preparar evidencias para la entrega final.<br><br>- **Huarcaya Matias, Gilbert Alonso**<br>&nbsp;&nbsp;- **AV1:** Evidenció aprendizaje continuo al definir el refinamiento de backlog y del análisis de entrevistas con nuevas evidencias.<br>&nbsp;&nbsp;- **TB1:** Evidenció aprendizaje continuo al aprender arquitectura backend con Spring Boot, implementando endpoints REST y documentando despliegue.<br>&nbsp;&nbsp;- **AV2:** Evidenció aprendizaje continuo al completar el 100% del backend, documentar APIs implementadas y ayudar en integración con aplicaciones móviles, consolidando conocimientos de despliegue y documentación.<br>&nbsp;&nbsp;- **TB2:** Evidenció aprendizaje continuo al cerrar la integración de Kotlin, Flutter y backend, además de consolidar el reporte Sprint 3 y las evidencias de demostración final.                                                                                                                                                                                                                                                                                                                                               | En AV1, el equipo documentó brechas y acciones de mejora para sostener el aprendizaje continuo y la calidad del reporte en las siguientes entregas.<br><br>En TB1, el equipo evidenció aprendizaje continuo al desarrollar competencias en Kotlin, Flutter, UI/UX móvil y arquitectura backend, aplicando lo aprendido en entregables concretos.<br><br>En AV2, el equipo demostró consolidación de aprendizaje al completar el 100% del backend, implementar funcionalidades core en múltiples plataformas y elaborar material de validación, evidenciando crecimiento profesional continuo.<br><br>En TB2, el equipo consolidó el aprendizaje al cerrar la entrega final con validación de entrevistas, evaluación heurística, demos de producto y evidencia documental para la presentación final.                                                              |
